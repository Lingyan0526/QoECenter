...
# Compute the PSNR.
mkdir psnr
$PSNR 352 288 420 ${YUV_FILE} ref_video.yuv > ref_psnr.csv
$PSNR 352 288 420 ${YUV_FILE} result.yuv > psnr/psnr.csv

$PSNR 352 288 420 ${YUV_FILE} ref_video.yuv ssim > ref_ssim.csv
$PSNR 352 288 420 ${YUV_FILE} result.yuv ssim > ssim.csv
